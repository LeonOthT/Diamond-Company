...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <div className="absolute w-[30vw] h-[60vh] bg-black bg-opacity-70 shadow-amber-800 shadow-lg rounded-lg">
          ...
          <div className="absolute top-[30%] w-full h-[55%]">
            <div className="w-full flex flex-col items-center justify-center">
              <label className="block mb-8 w-[90%] rounded-lg">
                <span className="block text-sm mb-2 text-amber-700 opacity-60">
                  Username
                </span>
                <input
                  type="text"
                  ...
                  className="outline-none border-b-[0.1em] shadow-amber-800/50 shadow-xl border-b-black bg-zinc-300 bg-opacity-0 w-full text-white"
                />
              </label>
            </div>
            <div className="w-full flex flex-col items-center justify-center">
              <label className="block mb-8 w-[90%] rounded-lg">
                ...
                <input
                  ...
                  className="outline-none border-b-[0.1em] shadow-amber-800/50 shadow-lg border-b-black bg-zinc-300 bg-opacity-0 w-full text-white"
                />
              </label>
              <button
                type="submit"
                className="px-10 py-3 border-amber-900 border-[0.1em] mt-8 text-white uppercase font-bold
             hover:shadow-amber-900/50 hover:shadow-xl hover:text-amber-700 transition-all duration-300 rounded-lg cursor-pointer"
              >
                Login
              </button>
            </div>
